...
const PlayerShip = __webpack_require__(10);
const Weapon = __webpack_require__(13);
const EnemyShip = __webpack_require__(4);
const Scenery = __webpack_require__(12);
const Powerup = __webpack_require__(11);
...
const ENEMIES = __webpack_require__(6);
...
const PLAYER_SHIPS = __webpack_require__(14);
...
class GameView {
  constructor(game, canvas) {
    ...
    this.game = game;
    game.gameView = this;
    this.player = this.game.addPlayer(PLAYER_SHIPS[0]);
...
const ENEMY_WEAPON_ARRAY = __webpack_require__(7);
...
const WEAPON_LIST = __webpack_require__(9);
...
const PLAYER_SHIPS = [PLAYER_SHIP_1, PLAYER_SHIP_0];
