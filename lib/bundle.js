...
class Game {
  ...
  step(deltaT){
    ...
    case 7:
        ...
        this.addEnemy({debris: enemy_6_debris, damage: 12, hitPoints: 100, image: enemy_6, game: this, weapon: 4, sizeX: 35, sizeY: 80});
        }
        break;
    case 8:
        if(Math.random()*4000<deltaT){
        this.addEnemy({debris: enemy_7_debris, damage: 16, hitPoints: 120, image: enemy_7, game: this, weapon: 5, sizeX: 75});
        }
        break;
    case 9:
        if(Math.random()*4000<deltaT){
        this.addEnemy({debris: enemy_8_debris, damage: 20, hitPoints: 160, image: enemy_8, game: this, weapon: 6, sizeY: 95});
        }
        break;
    case 10:
        if(Math.random()*4000<deltaT){
        this.addEnemy({debris: enemy_9_debris, damage: 24, hitPoints: 225, image: enemy_9, game: this, weapon: 7, sizeX: 85, sizeY: 105});
        }
        break;
  case 11:
        if(Math.random()*6000<deltaT){
